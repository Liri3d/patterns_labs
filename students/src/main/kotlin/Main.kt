...
import main.kotlin.strat.studentFileProc.StudentYamlProc
...
//    val studentList = StudentTxtProc(inputFilePath)
...
//    val studentListJson = StudentJsonProc(filePathJson)
...
//    val studentListYaml = StudentYamlProc(filePathYaml)
...
//    println("Список студентов успешно записан в файл $fileNameYaml")
    ...
    val studentList = Student_list(filePath, StudentYamlProc())

    studentList.fileProcessor = StudentJsonProc()
    studentList.write_to_file("src/files", "output_students_from_yaml.json")
